...
def category_page(gender, category_, page_no):
    ...
    return render_template('category.html', page_name='category', gender_main=gender, category_main=category_, page_no_main=page_no,
                            items=items[lower_limit:upper_limit], lists=lists, pages=int((len(items)/show)+1),
